...
@Mixin(InventoryCraftingChest.class)
@Pseudo
public abstract class MixinInventoryCraftingChest {
    ...
    // InventoryCraftingChest overrides decrStackSize/setInventorySlotContents with tile-backed
