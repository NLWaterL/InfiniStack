...
public abstract class MixinNEIInfiniteStackSizeHandler {
    ...
    private void injectIsItemInfinite(ItemStack stack, CallbackInfoReturnable<Boolean> cir) {
    ...
    {
        heldItem.stackSize = Configurables.maxStackSize + 10;
    }*/
    ...
    public void redirectReplenishStackSize(ItemStack stack, int value) {
        stack.stackSize = Configurables.maxStackSize + 10;
        }
