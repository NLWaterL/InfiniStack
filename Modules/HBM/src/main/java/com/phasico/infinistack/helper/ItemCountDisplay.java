...
public class ItemCountDisplay {
    ...
    public static String formatStackSize(int count) {
        ...
        if (count < 100_000) return EnumChatFormatting.YELLOW + formatFloorDecimal(count / 1000.0, 1) + "k";
        if (count < 1_000_000) return EnumChatFormatting.YELLOW + Integer.toString(count / 1000) + "k";
        if (count < 100_000_000) return EnumChatFormatting.AQUA + formatFloorDecimal(count / 1_000_000.0, 1) + "m";
